...
- (instancetype)startMetronome {
    ...
    NSString *fileName = [NSString stringWithFormat:@"%@/%@", [[NSBundle mainBundle] bundlePath], @"plucky.mp3"];
...
//    if ((self = [super init]) != nil) {
    ...
    NSString *fileName = [NSString stringWithFormat:@"%@/%@", [[NSBundle mainBundle] bundlePath], @"metronomedown.mp3"];
...
//        [_engine connect: _player to: output fromBus: 0 toBus: 0 format: format];
        [_engine connect:_player to:_engine.mainMixerNode fromBus: 0 toBus: 0 format: format];
